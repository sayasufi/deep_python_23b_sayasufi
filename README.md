# Курс VK по углубленной разработке на python

---

## Домашнее задание 1 (введение, тестирование)
...
## Домашнее задание 3 (объектная модель, ООП)
...
## Домашнее задание 4 (дескрипторы, метаклассы, ABC)
...
## Домашнее задание 5 (стандартная библиотека)
...
## Домашнее задание 6 (потоки, процессы)
...
## Домашнее задание 9 (логирование)
